...
pub unsafe fn fbm_1d<S: Simd>(
    ...
    let mut result = simplex_1d::<S>(x);

    for _ in 1..octaves {
        x = S::mul_ps(x, lacunarity);
        amp = S::mul_ps(amp, gain);
        result = S::add_ps(result, simplex_1d::<S>(x));
    }
...
pub unsafe fn ridge_1d<S: Simd>(
    ...
    let mut amp = S::set1_ps(1.0);
    let mut result = S::sub_ps(S::set1_ps(1.0), S::abs_ps(simplex_1d::<S>(x)));
    ...
    for _ in 1..octaves {
        ...
        result = S::add_ps(
            result,
            S::sub_ps(S::set1_ps(1.0), S::abs_ps(simplex_1d::<S>(x))),
        );
    }
...
pub unsafe fn turbulence_1d<S: Simd>(
    ...
    let mut amp = S::set1_ps(1.0);
    let mut result = S::abs_ps(simplex_1d::<S>(x));

    for _ in 1..octaves {
        x = S::mul_ps(x, lacunarity);
        amp = S::mul_ps(amp, gain);
        result = S::add_ps(result, S::abs_ps(simplex_1d::<S>(x)));
    }
...
pub unsafe fn fbm_2d<S: Simd>(
    ...
    let mut result = simplex_2d::<S>(x, y);
    let mut amp = S::set1_ps(1.0);
...
pub unsafe fn turbulence_2d<S: Simd>(
    ...
    let mut result = S::abs_ps(simplex_2d::<S>(x, y));
    ...
    for _ in 1..octaves {
        ...
        result = S::add_ps(
            result,
            S::abs_ps(S::mul_ps(simplex_2d::<S>(x, y ), amp)),
        );
    }
...
pub unsafe fn turbulence_3d<S: Simd>(
    ...
    for _ in 1..octaves {
        ...
        result = S::add_ps(
            result,
            S::abs_ps(S::mul_ps(simplex_3d::<S>(x, y, z), amp)),
        );
    }
...
pub unsafe fn fbm_4d<S: Simd>(
    ...
    let mut result = simplex_4d::<S>(x, y, z, w);
    let mut amp = S::set1_ps(1.0);
    ...
    for _ in 1..octaves {
        ...
        w = S::mul_ps(w, lac);
        amp = S::mul_ps(amp, gain);
        result = S::add_ps(result, S::mul_ps(simplex_4d::<S>(x, y, z, w), amp));
    }
...
pub unsafe fn ridge_4d<S: Simd>(
    ...
    let mut result = S::sub_ps(S::set1_ps(1.0), S::abs_ps(simplex_4d::<S>(x, y, z, w)));
    let mut amp = S::set1_ps(1.0);
    ...
    for _ in 1..octaves {
        ...
        result = S::add_ps(
            ...
            S::sub_ps(
                S::set1_ps(1.0),
                S::abs_ps(S::mul_ps(simplex_4d::<S>(x, y, z, w), amp)),
            ),
        );
    }
...
pub unsafe fn turbulence_4d<S: Simd>(
    ...
    let mut result = S::abs_ps(simplex_4d::<S>(x, y, z, w));
    let mut amp = S::set1_ps(1.0);
