...
pub unsafe fn fbm_1d(
    ...
    smplx::fbm_1d::<Sse41>(F32x4(x), F32x4(lacunarity), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn turbulence_1d(
    ...
    smplx::turbulence_1d::<Sse41>(F32x4(x), F32x4(lacunarity), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn fbm_1d_f64(
    ...
    smplx_64::fbm_1d::<Sse41>(F64x2(x), F64x2(lacunarity), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn ridge_1d_f64(
    ...
    smplx_64::ridge_1d::<Sse41>(F64x2(x), F64x2(lacunarity), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn turbulence_1d_f64(
    ...
    smplx_64::turbulence_1d::<Sse41>(F64x2(x), F64x2(lacunarity), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn get_1d_noise(noise_type: &NoiseType) -> (Vec<f32>, f32, f32) {
    super::noise_helpers::get_1d_noise::<Sse41>(noise_type)
}
...
pub unsafe fn fbm_2d(
    ...
    smplx::fbm_2d::<Sse41>(F32x4(x), F32x4(y), F32x4(lac), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn turbulence_2d(
    ...
    smplx::turbulence_2d::<Sse41>(F32x4(x), F32x4(y), F32x4(lac), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn fbm_2d_f64(
    ...
    smplx_64::fbm_2d::<Sse41>(F64x2(x), F64x2(y), F64x2(lac), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn ridge_2d_f64(
    ...
    smplx_64::ridge_2d::<Sse41>(F64x2(x), F64x2(y), F64x2(lac), F64x2(gain), octaves, seed).0
}
/// Get a single value of 2d turbulence.
#[target_feature(enable = "sse4.1")]
pub unsafe fn turbulence_2d_f64(
    ...
    smplx_64::turbulence_2d::<Sse41>(F64x2(x), F64x2(y), F64x2(lac), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn get_2d_noise(noise_type: &NoiseType) -> (Vec<f32>, f32, f32) {
    super::noise_helpers::get_2d_noise::<Sse41>(noise_type)
}
...
pub unsafe fn get_3d_noise(noise_type: &NoiseType) -> (Vec<f32>, f32, f32) {
    super::noise_helpers::get_3d_noise::<Sse41>(noise_type)
}
...
pub unsafe fn get_4d_noise(noise_type: &NoiseType) -> (Vec<f32>, f32, f32) {
    super::noise_helpers::get_4d_noise::<Sse41>(noise_type)
}
