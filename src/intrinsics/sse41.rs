...
get_noise!(get_1d_noise, get_1d_noise, f32, noise_helpers_32, Sse41);
get_noise!(get_2d_noise, get_2d_noise, f32, noise_helpers_32, Sse41);
get_noise!(get_3d_noise, get_3d_noise, f32, noise_helpers_32, Sse41);
get_noise!(get_4d_noise, get_4d_noise, f32, noise_helpers_32, Sse41);
get_noise!(get_1d_noise, get_1d_noise_64, f64, noise_helpers_64, Sse41);
get_noise!(get_2d_noise, get_2d_noise_64, f64, noise_helpers_64, Sse41);
get_noise!(get_3d_noise, get_3d_noise_64, f64, noise_helpers_64, Sse41);
get_noise!(get_4d_noise, get_4d_noise_64, f64, noise_helpers_64, Sse41);
get_noise_scaled!(get_1d_noise, get_1d_scaled_noise, f32, Sse41);
get_noise_scaled!(get_2d_noise, get_2d_scaled_noise, f32, Sse41);
get_noise_scaled!(get_3d_noise, get_3d_scaled_noise, f32, Sse41);
get_noise_scaled!(get_4d_noise, get_4d_scaled_noise, f32, Sse41);
