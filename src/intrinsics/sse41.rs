...
pub unsafe fn fbm_1d(
    ...
    simplex_fbm::fbm_1d::<Sse41>(F32x4(x), F32x4(lacunarity), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn fbm_1d_f64(
    ...
    simplex_fbm_64::fbm_1d::<Sse41>(F64x2(x), F64x2(lacunarity), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn ridge_1d_f64(
    ...
    simplex_ridge_64::ridge_1d::<Sse41>(F64x2(x), F64x2(lacunarity), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn fbm_2d(
    ...
    simplex_fbm::fbm_2d::<Sse41>(F32x4(x), F32x4(y), F32x4(lac), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn fbm_2d_f64(
    ...
    simplex_fbm_64::fbm_2d::<Sse41>(F64x2(x), F64x2(y), F64x2(lac), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn ridge_2d_f64(
    ...
    simplex_ridge_64::ridge_2d::<Sse41>(F64x2(x), F64x2(y), F64x2(lac), F64x2(gain), octaves, seed)
        .0
}
/// Get a single value of 2d turbulence.
#[target_feature(enable = "sse4.1")]
...
pub unsafe fn ridge_3d_f64(
    ...
    simplex_ridge_64::ridge_3d::<Sse41>(
        F64x2(x),
        F64x2(y),
        F64x2(z),
        F64x2(lac),
...
pub unsafe fn ridge_4d_f64(
    ...
    simplex_ridge_64::ridge_4d::<Sse41>(
        F64x2(x),
        F64x2(y),
        F64x2(z),
        F64x2(w),
