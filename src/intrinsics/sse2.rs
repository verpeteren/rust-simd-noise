...
pub unsafe fn fbm_1d_f64(
    ...
    smplx_64::fbm_1d::<Sse2>(F64x2(x), F64x2(lacunarity), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn fbm_2d_f64(
    ...
    smplx_64::fbm_2d::<Sse2>(F64x2(x), F64x2(y), F64x2(lac), F64x2(gain), octaves, seed).0
}
