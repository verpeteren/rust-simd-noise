...
pub unsafe fn simplex_1d(x: __m128, seed: i32) -> __m128 {
    smplx::simplex_1d::<Sse2>(F32x4(x), seed).0
}
...
pub unsafe fn fbm_1d(
    ...
    simplex_fbm::fbm_1d::<Sse2>(F32x4(x), F32x4(lacunarity), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn ridge_1d(
    ...
    simplex_ridge::ridge_1d::<Sse2>(F32x4(x), F32x4(lacunarity), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn turbulence_1d(
    ...
    smplx::turbulence_1d::<Sse2>(F32x4(x), F32x4(lacunarity), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn simplex_1d_f64(x: __m128d, seed: i64) -> __m128d {
    smplx_64::simplex_1d::<Sse2>(F64x2(x), seed).0
}
/// Get a single value of 1d fractal brownian motion.
#[target_feature(enable = "sse2")]
pub unsafe fn fbm_1d_f64(
    ...
    simplex_fbm_64::fbm_1d::<Sse2>(F64x2(x), F64x2(lacunarity), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn ridge_1d_f64(
    ...
    simplex_ridge_64::ridge_1d::<Sse2>(F64x2(x), F64x2(lacunarity), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn turbulence_1d_f64(
    ...
    smplx_64::turbulence_1d::<Sse2>(F64x2(x), F64x2(lacunarity), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn get_1d_noise(noise_type: &NoiseType) -> (Vec<f32>, f32, f32) {
    crate::noise_helpers::get_1d_noise::<Sse2>(noise_type)
}
...
pub unsafe fn simplex_2d(x: __m128, y: __m128, seed: i32) -> __m128 {
    smplx::simplex_2d::<Sse2>(F32x4(x), F32x4(y), seed).0
}
...
pub unsafe fn fbm_2d(
    ...
    simplex_fbm::fbm_2d::<Sse2>(F32x4(x), F32x4(y), F32x4(lac), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn ridge_2d(
    ...
    simplex_ridge::ridge_2d::<Sse2>(F32x4(x), F32x4(y), F32x4(lac), F32x4(gain), octaves, seed).0
}
/// Get a single value of 2d turbulence.
#[target_feature(enable = "sse2")]
pub unsafe fn turbulence_2d(
    ...
    smplx::turbulence_2d::<Sse2>(F32x4(x), F32x4(y), F32x4(lac), F32x4(gain), octaves, seed).0
}
...
pub unsafe fn simplex_2d_f64(x: __m128d, y: __m128d, seed: i64) -> __m128d {
    smplx_64::simplex_2d::<Sse2>(F64x2(x), F64x2(y), seed).0
}
...
pub unsafe fn fbm_2d_f64(
    ...
    simplex_fbm_64::fbm_2d::<Sse2>(F64x2(x), F64x2(y), F64x2(lac), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn ridge_2d_f64(
    ...
    simplex_ridge_64::ridge_2d::<Sse2>(F64x2(x), F64x2(y), F64x2(lac), F64x2(gain), octaves, seed).0
}
/// Get a single value of 2d turbulence.
#[target_feature(enable = "sse2")]
pub unsafe fn turbulence_2d_f64(
    ...
    smplx_64::turbulence_2d::<Sse2>(F64x2(x), F64x2(y), F64x2(lac), F64x2(gain), octaves, seed).0
}
...
pub unsafe fn get_2d_noise(noise_type: &NoiseType) -> (Vec<f32>, f32, f32) {
    crate::noise_helpers::get_2d_noise::<Sse2>(noise_type)
}
...
pub unsafe fn simplex_3d(x: __m128, y: __m128, z: __m128, seed: i32) -> __m128 {
    smplx::simplex_3d::<Sse2>(F32x4(x), F32x4(y), F32x4(z), seed).0
}
...
pub unsafe fn simplex_3d_f64(x: __m128d, y: __m128d, z: __m128d, seed: i64) -> __m128d {
    smplx_64::simplex_3d::<Sse2>(F64x2(x), F64x2(y), F64x2(z), seed).0
}
...
pub unsafe fn ridge_3d_f64(
    ...
    simplex_ridge_64::ridge_3d::<Sse2>(
        F64x2(x),
        F64x2(y),
        F64x2(z),
        F64x2(lac),
...
pub unsafe fn get_3d_noise(noise_type: &NoiseType) -> (Vec<f32>, f32, f32) {
    crate::noise_helpers::get_3d_noise::<Sse2>(noise_type)
}
...
pub unsafe fn simplex_4d(x: __m128, y: __m128, z: __m128, w: __m128, seed: i32) -> __m128 {
    smplx::simplex_4d::<Sse2>(F32x4(x), F32x4(y), F32x4(z), F32x4(w), seed).0
}
...
pub unsafe fn simplex_4d_f64(x: __m128d, y: __m128d, z: __m128d, w: __m128d, seed: i64) -> __m128d {
    smplx_64::simplex_4d::<Sse2>(F64x2(x), F64x2(y), F64x2(z), F64x2(w), seed).0
}
/// Get a single value of 4d fractal brownian motion.
#[target_feature(enable = "sse2")]
...
pub unsafe fn ridge_4d_f64(
    ...
    simplex_ridge_64::ridge_4d::<Sse2>(
        F64x2(x),
        F64x2(y),
        F64x2(z),
        F64x2(w),
...
pub unsafe fn get_4d_noise(noise_type: &NoiseType) -> (Vec<f32>, f32, f32) {
    crate::noise_helpers::get_4d_noise::<Sse2>(noise_type)
}
