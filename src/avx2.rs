...
pub unsafe fn cellular_3d(
    ...
    cellular::cellular_3d::<Avx2>(x, y, z, distance_function, return_type, jitter)
}
...
pub unsafe fn fbm_1d(
    ...
    simplex::fbm_1d::<Avx2>(x, freq, lacunarity, gain, octaves)
}
...
pub unsafe fn ridge_1d(
    ...
    simplex::ridge_1d::<Avx2>(x, freq, lacunarity, gain, octaves)
}
...
pub unsafe fn turbulence_1d(
    ...
    simplex::turbulence_1d::<Avx2>(x, freq, lacunarity, gain, octaves)
}
...
pub unsafe fn get_1d_noise(
    ...
    noise_helpers::get_1d_noise::<Avx2>(start_x, width, noise_type)
}
...
pub unsafe fn get_1d_scaled_noise(
    ...
    scale_noise::<Avx2>(scale_min, scale_max, min, max, &mut noise);
    noise
}
...
pub unsafe fn fbm_2d(
    ...
    simplex::fbm_2d::<Avx2>(x, y, freq, lac, gain, octaves)
}
...
pub unsafe fn ridge_2d(
    ...
    simplex::ridge_2d::<Avx2>(x, y, freq, lac, gain, octaves)
}
/// Get a single value of 2d turbulence.
#[target_feature(enable = "avx2")]
pub unsafe fn turbulence_2d(
    ...
    simplex::turbulence_2d::<Avx2>(x, y, freq, lac, gain, octaves)
}
...
pub unsafe fn get_2d_noise(
    ...
    noise_helpers::get_2d_noise::<Avx2>(start_x, width, start_y, height, noise_type)
}
...
pub unsafe fn fbm_3d(
    ...
    simplex::fbm_3d::<Avx2>(x, y, z, freq, lac, gain, octaves)
}
...
pub unsafe fn ridge_3d(
    ...
    simplex::ridge_3d::<Avx2>(x, y, z, freq, lac, gain, octaves)
}
...
pub unsafe fn turbulence_3d(
    ...
    simplex::turbulence_3d::<Avx2>(x, y, z, freq, lac, gain, octaves)
}
...
pub unsafe fn get_3d_noise(
    ...
    noise_helpers::get_3d_noise::<Avx2>(start_x, width, start_y, height, start_z, depth, noise_type)
}
...
pub unsafe fn simplex_4d(x: __m256, y: __m256, z: __m256, w: __m256) -> __m256 {
    simplex::simplex_4d::<Avx2>(x, y, z, w)
}
...
pub unsafe fn fbm_4d(
    ...
    simplex::fbm_4d::<Avx2>(x, y, z, w, freq, lac, gain, octaves)
}
...
pub unsafe fn ridge_4d(
    ...
    simplex::ridge_4d::<Avx2>(x, y, z, w, freq, lac, gain, octaves)
}
...
pub unsafe fn turbulence_4d(
    ...
    simplex::turbulence_4d::<Avx2>(x, y, z, w, freq, lac, gain, octaves)
}
...
pub unsafe fn get_4d_noise(
    ...
    noise_helpers::get_4d_noise::<Avx2>(
