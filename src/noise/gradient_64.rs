...
pub unsafe fn grad1<S: Simd>(seed: i64, hash: S::Vi64) -> S::Vf64 {
    ...
    h_and_8.blendv(S::sub_pd(S::setzero_pd(), v), v)
}
...
pub unsafe fn grad2<S: Simd>(seed: i64, hash: S::Vi64) -> [S::Vf64; 2] {
    ...
    let gx = mask
        ...
        .blendv(S::sub_pd(S::setzero_pd(), x_magnitude), x_magnitude);
    let gy = mask
        .blendv(h_and_1, h_and_2)
        .blendv(S::sub_pd(S::setzero_pd(), y_magnitude), y_magnitude);
    [gx, gy]
}
...
pub unsafe fn grad4<S: Simd>(
    ...
    S::add_pd(
        h_and_1.blendv(S::sub_pd(S::setzero_pd(), u), u),
        S::add_pd(
            h_and_2.blendv(S::sub_pd(S::setzero_pd(), v), v),
            h_and_4.blendv(S::sub_pd(S::setzero_pd(), w), w),
        ),
    )
}
