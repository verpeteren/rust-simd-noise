...
unsafe fn do_intrinsic_cellular_2_avx2_32_normal() -> Vec<f32> {
    ...
    let (noise, _min, _max) = avx2::get_2d_noise::<simdeez::avx2::Avx2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_cellular_2_sse2_32_normal() -> Vec<f32> {
    ...
    let noise_type = CellularSettings::default(dims).with_seed(1337).wrap();
    let (noise, _min, _max) = sse2::get_2d_noise::<simdeez::sse2::Sse2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_cellular_2_sse41_32_normal() -> Vec<f32> {
    ...
    let noise_type = CellularSettings::default(dims).with_seed(1337).wrap();
    let (noise, _min, _max) = sse41::get_2d_noise::<simdeez::sse41::Sse41>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_cellular_3_avx2_32_normal() -> Vec<f32> {
    ...
    let noise_type = CellularSettings::default(dims).with_seed(1337).wrap();
    let (noise, _min, _max) = avx2::get_3d_noise::<simdeez::avx2::Avx2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_cellular_3_sse2_32_normal() -> Vec<f32> {
    ...
    let noise_type = CellularSettings::default(dims).with_seed(1337).wrap();
    let (noise, _min, _max) = sse2::get_3d_noise::<simdeez::sse2::Sse2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_cellular_3_sse41_32_normal() -> Vec<f32> {
    ...
    let noise_type = CellularSettings::default(dims).with_seed(1337).wrap();
    let (noise, _min, _max) = sse41::get_3d_noise::<simdeez::sse41::Sse41>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_1_avx2_32_normal() -> Vec<f32> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = avx2::get_1d_noise::<simdeez::avx2::Avx2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_1_avx2_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = avx2::get_1d_noise_64::<simdeez::avx2::Avx2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_1_sse2_32_normal() -> Vec<f32> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse2::get_1d_noise::<simdeez::sse2::Sse2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_1_sse2_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse2::get_1d_noise_64::<simdeez::sse2::Sse2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_1_sse41_32_normal() -> Vec<f32> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse41::get_1d_noise::<simdeez::sse41::Sse41>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_1_sse41_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse41::get_1d_noise_64::<simdeez::sse41::Sse41>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_2_avx2_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = avx2::get_2d_noise_64::<simdeez::avx2::Avx2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_2_sse2_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse2::get_2d_noise_64::<simdeez::sse2::Sse2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_2_sse41_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse41::get_2d_noise_64::<simdeez::sse41::Sse41>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_3_avx2_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = avx2::get_3d_noise_64::<simdeez::avx2::Avx2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_3_sse2_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse2::get_3d_noise_64::<simdeez::sse2::Sse2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_3_sse41_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse41::get_3d_noise_64::<simdeez::sse41::Sse41>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_4_avx2_32_normal() -> Vec<f32> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = avx2::get_4d_noise::<simdeez::avx2::Avx2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_4_avx2_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = avx2::get_4d_noise_64::<simdeez::avx2::Avx2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_4_sse2_32_normal() -> Vec<f32> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse2::get_4d_noise::<simdeez::sse2::Sse2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_4_sse2_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse2::get_4d_noise_64::<simdeez::sse2::Sse2>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_4_sse41_32_normal() -> Vec<f32> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse41::get_4d_noise::<simdeez::sse41::Sse41>(&noise_type);
    noise
}
...
unsafe fn do_intrinsic_ridge_4_sse41_64_normal() -> Vec<f64> {
    ...
    let noise_type = RidgeSettings::default(dims)
        ...
        .with_octaves(5)
        .wrap();
    let (noise, _min, _max) = sse41::get_4d_noise_64::<simdeez::sse41::Sse41>(&noise_type);
    noise
}
